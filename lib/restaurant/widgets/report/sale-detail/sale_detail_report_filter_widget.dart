...
class SaleDetailReportFilterWidget extends StatelessWidget {
  final List<OptionModel> filters;
  const SaleDetailReportFilterWidget({super.key, required this.filters});
      ...
      child: Column(
        ...
        children: [
          for (int i = 0; i < filters.length; i++)
            Selector<SaleDetailReportProvider, OptionModel>(
